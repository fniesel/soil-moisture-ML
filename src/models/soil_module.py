...
from torchmetrics import MeanMetric, MeanAbsoluteError, MinMetric
from torchmetrics.classification.accuracy import Accuracy


class SoilLitModule(LightningModule):
    def __init__(
        self,
        net: torch.nn.Module,
...
if __name__ == "__main__":
    _ = SoilLitModule(None, None, None, None)
